...
- If human-facing documentation (README, API references, etc.; AI-facing prompts under `.codex/` are out of scope) was added or modified, Read `{{plugin_root}}/rules/document.md` and check for violations. If any violation exists, mark as Feedback.
